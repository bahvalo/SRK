...
void NavierSolver::Step(real_t &time, real_t dt, int current_step, bool provisional)
{
   sw_step.Start();

   // Set the coefficients of the time extrapolation and of the backward differentiation formulas
